...
const SignIn = () => {
    ...
    setError('Oops! Ran into an error signing in with password and email!');
  ...
  return (
    <div className="sign-in">
      <img className="sign-in--logo" src={logo} alt="Medium Editor logo" />
      <h1>Medium Editor</h1>
      <h2>Sign In</h2>
      ...
      <form>
        <div className="sign-in--option">
          ...
          <input
            ...
            name="userEmail"
            value = {email}
            placeholder="E.g: jane.doe@gmai.com"
            id="userEmail"
